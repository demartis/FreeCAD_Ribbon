...
public:
    ...
    void setup(const QString& workbenchName,ToolBarItem*);
    ...
    static ToolBarManagerInterface* getToolbarImplementation();
...
private:
    ...
    static ToolBarManagerInterface* _implementation;
};
